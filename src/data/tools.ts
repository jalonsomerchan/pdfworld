...
export const pdfToolCategories = [
  ...
  },
  {
    ...
    description: { es: 'Firma visualmente, revisa límites de protección y gestiona PDFs manteniendo el control de tus archivos.', en: 'Visually sign, review protection limits and manage PDFs while keeping control of your files.' },
    icon: '🔐',
    seo: { title: { es: 'Herramientas de seguridad PDF privadas', en: 'Private PDF security tools' }, description: { es: 'Opciones para firmar visualmente y revisar límites de seguridad PDF directamente en el navegador.', en: 'Options to visually sign and review PDF security limits directly in the browser.' } },
  },
  {
    id: 'edicion',
    title: { es: 'Editar PDF', en: 'Edit PDF' },
    description: { es: 'Edita metadatos, numera páginas, añade marcas de agua y prepara pequeñas modificaciones de documentos PDF.', en: 'Edit metadata, number pages, add watermarks and prepare small changes to PDF documents.' },
    icon: '✏️',
  ...
  },
  {
    ...
    description: { es: 'Herramientas auxiliares para revisar, limpiar, probar y preparar archivos PDF.', en: 'Helper tools to review, clean, test and prepare PDF files.' },
    icon: '🧰',
...
export const pdfTools = [
  ...
  },
  {
    ...
    description: { es: 'Añade una firma visual dibujada o subida como imagen a una página del PDF.', en: 'Add a visual signature drawn or uploaded as an image to a PDF page.' },
    category: 'seguridad', route: 'firmar-pdf', icon: '✍️', status: 'available',
    keywords: ['firmar pdf', 'firma pdf', 'firma visual', 'sign pdf', 'signature pdf', 'pdf-lib'],
    seo: { title: { es: 'Firmar PDF online con firma visual', en: 'Sign PDF online with a visual signature' }, description: { es: 'Dibuja o sube una firma y colócala visualmente en un PDF desde el navegador, sin subir archivos.', en: 'Draw or upload a signature and place it visually in a PDF from the browser, without uploads.' } },
  },
  {
    id: 'extract-text-pdf',
  ...
  },
  {
    ...
    description: { es: 'Convierte páginas seleccionadas de un PDF en imágenes PNG o JPG y descárgalas como archivo o ZIP.', en: 'Convert selected PDF pages into PNG or JPG images and download them as a file or ZIP.' },
    category: 'convertir', route: 'extraer-imagenes-pdf', icon: '🖼️', status: 'available',
    keywords: ['extraer imagenes pdf', 'pdf a png', 'pdf a jpg', 'convertir pdf imagen', 'extract pdf images', 'pdf.js', 'zip'],
    seo: { title: { es: 'Extraer imágenes de PDF online gratis y privado', en: 'Extract PDF images online for free and privately' }, description: { es: 'Exporta páginas de PDF como PNG o JPG directamente en el navegador, con descarga individual o ZIP.', en: 'Export PDF pages as PNG or JPG directly in the browser, with individual or ZIP download.' } },
  },
  {
    id: 'scan-pdf',
  ...
  },
  {
    ...
    description: { es: 'Consulta los límites reales de proteger PDFs con contraseña desde el navegador sin subir archivos.', en: 'Review the real limits of password-protecting PDFs in the browser without uploads.' },
    category: 'seguridad', route: 'proteger-pdf', icon: '🛡️', status: 'available',
    keywords: ['proteger pdf', 'contraseña pdf', 'cifrar pdf', 'protect pdf', 'pdf security'],
    seo: { title: { es: 'Proteger PDF con contraseña: límites en navegador', en: 'Protect PDF with password: browser limits' }, description: { es: 'Página técnica sobre protección PDF con contraseña, cifrado real y límites de hacerlo solo en navegador.', en: 'Technical page about PDF password protection, real encryption and browser-only limits.' } },
  },
  {
    id: 'unlock-pdf',
    title: { es: 'Desbloquear PDF', en: 'Unlock PDF' },
    description: { es: 'Revisa qué se puede hacer con PDFs protegidos cuando conoces la contraseña, sin fuerza bruta ni bypass.', en: 'Review what can be done with protected PDFs when you know the password, without brute force or bypass.' },
    category: 'seguridad', route: 'desbloquear-pdf', icon: '🔓', status: 'available',
    keywords: ['desbloquear pdf', 'quitar contraseña pdf', 'unlock pdf', 'password pdf', 'pdf.js'],
    seo: { title: { es: 'Desbloquear PDF con contraseña conocida', en: 'Unlock PDF with a known password' }, description: { es: 'Página técnica sobre desbloquear PDFs solo con contraseña conocida, sin cracking ni llamadas a servidor.', en: 'Technical page about unlocking PDFs only with a known password, without cracking or server calls.' } },
  },
  {
    id: 'edit-metadata',
    title: { es: 'Editar metadatos PDF', en: 'Edit PDF metadata' },
    description: { es: 'Cambia título, autor, asunto, palabras clave, creador y productor de un PDF.', en: 'Change title, author, subject, keywords, creator and producer in a PDF.' },
    category: 'edicion', route: 'editar-metadatos-pdf', icon: '🏷️', status: 'available',
    keywords: ['metadatos pdf', 'editar pdf', 'titulo pdf', 'autor pdf', 'pdf metadata', 'pdf-lib'],
    seo: { title: { es: 'Editar metadatos PDF online gratis y privado', en: 'Edit PDF metadata online for free and privately' }, description: { es: 'Edita metadatos básicos de documentos PDF con una herramienta frontend, sin subir archivos.', en: 'Edit basic metadata in PDF documents with a frontend tool, without uploads.' } },
  },
  {
    id: 'page-numbers',
    title: { es: 'Numerar páginas PDF', en: 'Add PDF page numbers' },
    description: { es: 'Añade numeración visible a las páginas de tus documentos PDF con formato y posición configurables.', en: 'Add visible page numbers to your PDF documents with configurable format and position.' },
    category: 'edicion', route: 'numerar-paginas-pdf', icon: '🔢', status: 'available',
    keywords: ['numerar pdf', 'números de página pdf', 'pagina n de total', 'page numbers pdf', 'pdf-lib'],
    seo: { title: { es: 'Numerar páginas PDF online gratis y privado', en: 'Add page numbers to PDF online for free and privately' }, description: { es: 'Añade números de página a documentos PDF desde el navegador con formato, posición, tamaño y margen configurables.', en: 'Add page numbers to PDF documents from the browser with configurable format, position, size and margin.' } },
  },
  {
    id: 'jpg-to-pdf',
